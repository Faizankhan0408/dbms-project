...
<body>
           ...
           <hr>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="btn-group" role="group" aria-label="Basic checkbox toggle button group" style="margin-top:25px">
                                ...
                                <label class="btn btn-outline-warning" for="Social Media Marketing"><a class="" href="bussiness.php/#SocialMediaMarketing" style="text-decoration:none;color:rgb(255,207,64);">Social Media
                                        Marketing</a></label>
    ...
    <div class="container my-4">
        ...
        <div class="row my-2">
            ...
            <div class="col-lg-4 my-2">
                <img src="desk.jpg" alt="" style="width:70%; height:70%; border-radius:50%;">
                <h2>Rajat Goyal</h2>
                <p><i>CEO</i></p>
